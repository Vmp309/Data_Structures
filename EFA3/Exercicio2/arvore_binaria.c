...
int folhas (Arv* a){
    ...
    conta_folhas(a->raiz, &contador_folhas);
    
    return contador_folhas;
}

int conta_folhas(ArvNo* no, int *contador_folhas){
    ...
    conta_folhas(no->esq, contador_folhas);
    conta_folhas(no->dir, contador_folhas);
